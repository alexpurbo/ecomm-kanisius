...
export default function PaginationLinks({ meta, onPageClick }) {
    ...
    return (
        <>
            {meta.total > 0 && (
                <div className="flex items-center justify-between border-t border-slate-300 bg-white px-4 py-3 sm:px-6 shadow-md mt-4">
                    ...
                    <div className="hidden sm:flex-col sm:flex sm:flex-1 sm:items-center sm:justify-between">
                        ...
                        <div className="flex items-center justify-end w-full">
                            <p className="font-semibold text-sm text-slate-500">
                                Menampilkan {meta.from} sampai {meta.to} produk
                                dari total {meta.total} produk
                            </p>
                        </div>
                        {/* End Left Data */}
