...
export default function Category() {
    ...
    const [categoryName, setCategoryName] = useState(categorySelected);
    const [subcategoryName, setSubcategoryName] = useState();
    const [subcategoryDtlName, setSubcategoryDtlName] = useState();
    ...
    useEffect(() => {
        ...
        setSubcategoryName(subcategory);
        setCategoryName(category);
        setSubcategoryDtlName(subcategorydetail);
        setUrlPathname("/category");
    }, []);
                    ...
                    <div className="relative h-full w-full">
                        <div className="absolute md:inset-x-24 inset-x-4 py-2 md:px-8 px-4 bg-slate-50 mx-auto -bottom-3 rounded-lg shadow-lg">
                            <p className="md:font-medium font-light md:text-lg text-sm">
                                ...
                                {subcategorydetail ? (
                                    <NavLink
                                        to={`/category/${category}/${subcategory}/${subcategorydetail}`}
                                    >
                                        {subcategorydetail
                                            .replace(/-/g, " ")
                                            .split(" ")
